...
def get_comments_for_trading_dates(api_key, video_ids_file='data/video_IDs.txt', trading_dates_file='data/trading_dates.txt', checkpoint_file='checkpoint.txt', output_file='comments.csv', max_comments_per_date=200):
    # trading dates
